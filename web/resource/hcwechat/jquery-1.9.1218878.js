...
var s, o, u = at.expando, a = typeof n == "string", f = e.nodeType, l = f ? at.cache : e, c = f ? e[u] : e[u] && u;
...
function s(e, t, n) {
if (!at.acceptData(e)) return;
var r, i, s, o = e.nodeType, a = o ? at.cache : e, f = o ? e[at.expando] : at.expando;
if (!a[f]) return;
if (t) {
s = n ? a[f] : a[f].data;
if (s) {
...
function m(e, t) {
var n, r = 0;
for (; (n = e[r]) != null; r++) at._data(n, "globalEval", !t || at._data(t[r], "globalEval"));
}
function g(e, t) {
if (t.nodeType !== 1 || !at.hasData(e)) return;
var n, r, i, s = at._data(e), o = at._data(t, s), u = s.events;
if (u) {
delete o.handle, o.events = {};
for (n in u) for (r = 0, i = u[n].length; r < i; r++) at.event.add(t, n, u[n][r]);
}
...
if (n === "script" && t.text !== e.text) d(t).text = e.text, v(t); else if (n === "object") t.parentNode && (t.outerHTML = e.outerHTML), at.support.html5Clone && e.innerHTML && !at.trim(t.innerHTML) && (t.innerHTML = e.innerHTML); else if (n === "input" && tn.test(e.type)) t.defaultChecked = t.checked = e.checked, t.value !== e.value && (t.value = e.value); else if (n === "option") t.defaultSelected = t.selected = e.defaultSelected; else if (n === "input" || n === "textarea") t.defaultValue = e.defaultValue;
}
function b(e, n) {
var r, i, s = 0, o = typeof e.getElementsByTagName !== $ ? e.getElementsByTagName(n || "*") : typeof e.querySelectorAll !== $ ? e.querySelectorAll(n || "*") : t;
if (!o) for (o = [], r = e.childNodes || e; (i = r[s]) != null; s++) !n || at.nodeName(i, n) ? o.push(i) : at.merge(o, b(i, n));
...
function C(e, t, n) {
var r = !0, i = t === "width" ? e.offsetWidth : e.offsetHeight, s = cn(e), o = at.support.boxSizing && at.css(e, "boxSizing", !1, s) === "border-box";
if (i <= 0 || i == null) {
i = hn(e, t, s);
...
function L(e, t) {
var n = at(t.createElement(e)).appendTo(t.body), r = at.css(n[0], "display");
return n.remove(), r;
}
function A(e, t, n, r) {
var i;
...
}); else if (!n && at.type(t) === "object") for (i in t) A(e + "[" + i + "]", t[i], n, r); else r(e, t);
}
function O(e) {
return function(t, n) {
typeof t != "string" && (n = t, t = "*");
var r, i = 0, s = t.toLowerCase().match(lt) || [];
if (at.isFunction(n)) while (r = s[i++]) r[0] === "+" ? (r = r.slice(1) || "*", (e[r] = e[r] || []).unshift(n)) : (e[r] = e[r] || []).push(n);
};
}
function M(e, t, n, r) {
function i(u) {
...
var r = (sr[t] || []).concat(sr["*"]), i = 0, s = r.length;
for (; i < s; i++) if (r[i].call(e, t, n)) return;
});
}
function I(e, t, n) {
var r, i, s = 0, o = ir.length, u = at.Deferred().always(function() {
delete a.elem;
}), a = function() {
if (i) return !1;
var t = Zn || j(), n = Math.max(0, f.startTime + f.duration - t), r = n / f.duration || 0, s = 1 - r, o = 0, a = f.tweens.length;
...
var X, V, $ = typeof t, J = e.document, K = e.location, Q = e.jQuery, G = e.$, Y = {}, Z = [], et = "1.9.1", tt = Z.concat, nt = Z.push, rt = Z.slice, it = Z.indexOf, st = Y.toString, ot = Y.hasOwnProperty, ut = et.trim, at = function(e, t) {
return new at.fn.init(e, t, V);
}, ft = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, lt = /\S+/g, ct = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, ht = /^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/, pt = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, dt = /^[\],:{}\s]*$/, vt = /(?:^|:|,)(?:\s*\[)+/g, mt = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g, gt = /"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g, yt = /^-ms-/, bt = /-([\da-z])/gi, wt = function(e, t) {
...
if (pt.test(i[1]) && at.isPlainObject(n)) for (i in n) at.isFunction(this[i]) ? this[i](n[i]) : this.attr(i, n[i]);
return this;
}
...
if (u) for (; s < o; s++) i = t(e[s], s, r), i != null && (a[a.length] = i); else for (s in e) i = t(e[s], s, r), i != null && (a[a.length] = i);
return tt.apply([], a);
},
guid: 1,
proxy: function(e, n) {
...
if (!X) {
X = at.Deferred();
if (J.readyState === "complete") setTimeout(at.ready); else if (J.addEventListener) J.addEventListener("DOMContentLoaded", Et, !1), e.addEventListener("load", Et, !1); else {
...
Deferred: function(e) {
var t = [ [ "resolve", "done", at.Callbacks("once memory"), "resolved" ], [ "reject", "fail", at.Callbacks("once memory"), "rejected" ], [ "notify", "progress", at.Callbacks("memory") ] ], n = "pending", r = {
state: function() {
return n;
},
always: function() {
...
var o = s[0], u = at.isFunction(e[t]) && e[t];
i[s[1]](function() {
...
when: function(e) {
var t = 0, n = rt.call(arguments), r = n.length, i = r !== 1 || e && at.isFunction(e.promise) ? r : 0, s = i === 1 ? e : at.Deferred(), o = function(e, t, n) {
return function(r) {
...
var n, r, i, s = "padding:0;margin:0;border:0;display:block;box-sizing:content-box;-moz-box-sizing:content-box;-webkit-box-sizing:content-box;", o = J.getElementsByTagName("body")[0];
if (!o) return;
...
t = t || "fx";
var n = at.queue(e, t), r = n.length, i = n.shift(), s = at._queueHooks(e, t), o = function() {
at.dequeue(e, t);
};
...
var r, i = 1, s = at.Deferred(), o = this, u = this.length, a = function() {
--i || s.resolveWith(o, [ o ]);
};
...
if (n === "string") {
var i, s = 0, o = at(this), u = t, a = e.match(lt) || [];
...
for (; n < r; n++) if (this[n].nodeType === 1 && (" " + this[n].className + " ").replace(Lt, " ").indexOf(t) >= 0) return !0;
return !1;
},
val: function(e) {
var n, r, i, s = this[0];
...
var n, r, i = 0, s = t && t.match(lt);
if (s && e.nodeType === 1) while (n = s[i++]) r = at.propFix[n] || n, _t.test(n) ? !Pt && Dt.test(n) ? e[at.camelCase("default-" + n)] = e[r] = !1 : e[r] = !1 : at.attr(e, n, ""), e.removeAttribute(Pt ? n : r);
},
attrHooks: {
type: {
set: function(e, t) {
...
get: function(e, n) {
var r = at.prop(e, n), i = typeof r == "boolean" && e.getAttribute(n), s = typeof r == "boolean" ? Ht && Pt ? i != null : Dt.test(n) ? e[at.camelCase("default-" + n)] : !!i : e.getAttributeNode(n);
...
var Bt = /^(?:input|select|textarea)$/i, jt = /^key/, Ft = /^(?:mouse|contextmenu)|click/, It = /^(?:focusinfocus|focusoutblur)$/, qt = /^([^.]*)(?:\.(.+)|)$/;
at.event = {
global: {},
...
var o, u, a, f, l, c, h, p = [ i || J ], d = ot.call(n, "type") ? n.type : n, v = ot.call(n, "namespace") ? n.namespace.split(".") : [];
a = c = i = i || J;
...
dispatch: function(e) {
e = at.event.fix(e);
var n, r, i, s, o, u = [], a = rt.call(arguments), f = (at._data(this, "events") || {})[e.type] || [], l = at.event.special[e.type] || {};
a[0] = e, e.delegateTarget = this;
if (l.preDispatch && l.preDispatch.call(this, e) === !1) return;
u = at.event.handlers.call(this, e, f), n = 0;
while ((s = u[n++]) && !e.isPropagationStopped()) {
e.currentTarget = s.elem, o = 0;
while ((i = s.handlers[o++]) && !e.isImmediatePropagationStopped()) if (!e.namespace_re || e.namespace_re.test(i.namespace)) e.handleObj = i, e.data = i.data, r = ((at.event.special[i.origType] || {}).handle || i.handler).apply(s.elem, a), r !== t && (e.result = r) === !1 && (e.preventDefault(), e.stopPropagation());
}
...
var n = e.target, r = at.nodeName(n, "input") || at.nodeName(n, "button") ? n.form : t;
...
if (i === !1) i = f; else if (!i) return this;
...
function p(e, t, n) {
var r = t.dir, i = n && r === "parentNode", s = z++;
...
var f, l, c, h = [], p = [], d = o.length, m = i || b(t || "*", u.nodeType ? [ u ] : u, []), g = e && (i || !t) ? v(m, h, e, u, a) : m, y = n ? s || (i ? e : d || r) ? [] : o : g;
n && n(g, y, u, a);
if (r) {
...
function g(e) {
var t, n, r, i = e.length, s = T.relative[e[0].type], o = s || T.relative[" "], u = s ? 1 : 0, a = p(function(e) {
return e === t;
}, o, !0), f = p(function(e) {
return Z.call(t, e) > -1;
...
for (; u < i; u++) if (n = T.relative[e[u].type]) l = [ p(d(l), n) ]; else {
n = T.filter[e[u].type].apply(null, e[u].matches);
if (n[I]) {
r = ++u;
for (; r < i; r++) if (T.relative[e[r].type]) break;
...
var c, h, p, d = [], m = 0, g = "0", y = i && [], b = l != null, w = A, E = i || s && T.find.TAG("*", l && u.parentNode || u), S = U += w == null ? 1 : Math.random() || .1;
b && (A = u !== M && u, x = n);
for (; (c = E[g]) != null; g++) {
if (s && c) {
h = 0;
...
if (i) {
if (m > 0) while (g--) !y[g] && !d[g] && (d[g] = Q.call(f));
d = v(d);
}
...
if (a = T.find[u]) if (r = a(o.matches[0].replace(wt, Et), pt.test(s[0].type) && t.parentNode || t)) {
...
if (!i) for (; t = e[r]; r++) n += N(t); else if (i === 1 || i === 9 || i === 11) {
...
} else if (y && (f = (t[I] || (t[I] = {}))[e]) && f[0] === U) h = f[1]; else while (c = ++p && c && c[v] || (h = p = 0) || d.pop()) if ((u ? c.nodeName.toLowerCase() === g : c.nodeType === 1) && ++h) {
y && ((c[I] || (c[I] = {}))[e] = [ U, h ]);
if (c === t) break;
}
...
var n;
do if (n = D ? t.getAttribute("xml:lang") || t.getAttribute("lang") : t.lang) return n = n.toLowerCase(), n === e || n.indexOf(e + "-") === 0; while ((t = t.parentNode) && t.nodeType === 1);
return !1;
};
}),
target: function(t) {
...
var Rt = /Until$/, Ut = /^(?:parents|prev(?:Until|All))/, zt = /^.[^:#\[\.,]*$/, Wt = at.expr.match.needsContext, Xt = {
children: !0,
contents: !0,
next: !0,
prev: !0
...
for (t = 0; t < i; t++) if (at.contains(r[t], this)) return !0;
}));
n = [];
...
has: function(e) {
var t, n = at(e, this), r = n.length;
return this.filter(function() {
for (t = 0; t < r; t++) if (at.contains(this, n[t])) return !0;
});
},
not: function(e) {
...
var n, r = 0, i = this.length, s = [], o = Wt.test(e) || typeof e != "string" ? at(e, t || this.context) : 0;
for (; r < i; r++) {
n = this[r];
...
add: function(e, t) {
var n = typeof e == "string" ? at(e, t) : at.makeArray(e && e.nodeType ? [ e ] : e), r = at.merge(this.get(), n);
...
}, an = h(J), fn = an.appendChild(J.createElement("div"));
...
remove: function(e, t) {
var n, r = 0;
for (; (n = this[r]) != null; r++) if (!e || at.filter(e, [ n ]).length > 0) !t && n.nodeType === 1 && at.cleanData(b(n)), n.parentNode && (t && at.contains(n.ownerDocument, n) && m(b(n, "script")), n.parentNode.removeChild(n));
return this;
},
empty: function() {
var e, t = 0;
...
e = tt.apply([], e);
var i, s, o, u, a, f, l = 0, c = this.length, h = this, m = c - 1, g = e[0], y = at.isFunction(g);
...
at.fn[e] = function(e) {
var n, r = 0, i = [], s = at(e), o = s.length - 1;
...
r = b(s), u = b(e);
for (o = 0; (i = u[o]) != null; ++o) r[o] && y(i, r[o]);
}
if (t) if (n) {
u = u || b(e), r = r || b(s);
for (o = 0; (i = u[o]) != null; o++) g(i, r[o]);
} else g(e, s);
...
for (; v < c; v++) {
s = e[v];
if (s || s === 0) if (at.type(s) === "object") at.merge(d, s.nodeType ? [ s ] : s); else if (!Zt.test(s)) d.push(t.createTextNode(s)); else {
...
var n, r, i, s, o = 0, u = at.expando, a = at.cache, f = at.support.deleteExpando, l = at.event.special;
for (; (n = e[o]) != null; o++) if (t || at.acceptData(n)) {
i = n[u], s = i && a[i];
if (s) {
if (s.events) for (r in s.events) l[r] ? at.event.remove(n, r) : at.removeEvent(n, r, s.handle);
a[i] && (delete a[i], f ? delete n[u] : typeof n.removeAttribute !== $ ? n.removeAttribute(u) : n[u] = null, Z.push(i));
}
}
}
});
var ln, cn, hn, pn = /alpha\([^)]*\)/i, dn = /opacity\s*=\s*([^)]*)/, vn = /^(top|right|bottom|left)$/, mn = /^(none|table(?!-c[ea]).+)/, gn = /^margin/, yn = new RegExp("^(" + ft + ")(.*)$", "i"), bn = new RegExp("^(" + ft + ")(?!px)[a-z%]+$", "i"), wn = new RegExp("^([+-])=(" + ft + ")", "i"), En = {
BODY: "block"
}, Sn = {
position: "absolute",
visibility: "hidden",
...
var s, o, u, a = at.camelCase(n), f = e.style;
...
set: function(e, t) {
var n = e.style, r = e.currentStyle, i = at.isNumeric(t) ? "alpha(opacity=" + t * 100 + ")" : "", s = r && r.filter || n.filter || "";
n.zoom = 1;
...
if (e >= 200 && e < 300 || e === 304) h.ifModified && (E = S.getResponseHeader("Last-Modified"), E && (at.lastModified[o] = E), E = S.getResponseHeader("etag"), E && (at.etag[o] = E)), e === 204 ? (s = !0, x = "nocontent") : e === 304 ? (s = !0, x = "notmodified") : (s = P(h, b), x = s.state, c = s.data, y = s.error, s = !y); else {
y = x;
...
var i, s, o, u, a, f, l, c, h = at.ajaxSetup({}, n), p = h.context || h, d = h.context && (p.nodeType || p.jquery) ? at(p) : at.event, v = at.Deferred(), m = at.Callbacks("once memory"), g = h.statusCode || {}, y = {}, b = {}, w = 0, E = "canceled", S = {
readyState: 0,
...
var t;
if (e) if (w < 2) for (t in e) g[t] = [ g[t], e[t] ]; else S.always(e[S.status]);
return this;
},
abort: function(e) {
var t = e || E;
...
var Zn, er, tr = /^(?:toggle|show|hide)$/, nr = new RegExp("^(?:([+-])=|)(" + ft + ")([a-z%]*)$", "i"), rr = /queueHooks$/, ir = [ R ], sr = {
"*": [ function(e, t) {
var n, r, i = this.createTween(e, t), s = nr.exec(t), o = i.cur(), u = +o || 0, a = 1, f = 20;
if (s) {
...
var i = at.isEmptyObject(e), s = at.speed(t, n, r), o = function() {
...
var t = !0, n = e != null && e + "queueHooks", s = at.timers, o = at._data(this);
...
var t, n = at._data(this), r = n[e + "queue"], i = n[e + "queueHooks"], s = at.timers, o = r ? r.length : 0;
...
var i = at(e), s = i.offset(), o = at.css(e, "top"), u = at.css(e, "left"), a = (r === "absolute" || r === "fixed") && at.inArray("auto", [ o, u ]) > -1, f = {}, l = {}, c, h;
...
}), e.jQuery = e.$ = at, typeof define == "function" && define.amd && define.amd.jQuery && define("biz_common/jquery-1.9.1.js", [], function(e, t, n) {
try {
var r = +(new Date);
return at;
} catch (i) {
